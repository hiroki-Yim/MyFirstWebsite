...
<body>
  <div class="container">
    ...
    <input type="button" class="btn btn-success" onclick="locationView('modify',<?= $num ?>);" value="수정하기">
  ...
  <?php require_once('div-comment.php'); ?>
    ...
    <form class="comment" method="post" action="comment.php?page=<?= $page ?>">
      ...
      <div class="md-form mb-4 pink-textarea active-pink-textarea" id="comment_input">
        ...
        <label for="form21" class="id">댓글 남기기 : <code><?= $sid ?></code></label>
