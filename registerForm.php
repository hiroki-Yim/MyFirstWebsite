...
<body>
  <form id="msform" method="post" action="register.php">
    ...
    <fieldset>
      ...
      <input type="tel" maxlength="7" pattern="[0-9]{7}" name="id" title="학번 형식으로 입력해 주세요!" placeholder="본인의 학번 7자리를 입력 해 주세요." required> 비밀번호
      <input type="password" maxlength="15" name="pwd" pattern=".{6,}" title="6자 이상 입력 해 주세요!" placeholder="비밀번호 6자 이상" required>
