...
$id = isset($_SESSION["id"])?$_SESSION["id"]:"";  // 로그인 된 사용자의 정보를 가져온다.
...
<body>
  <form id="msform" method="post" action="update.php">
    <fieldset>    <!-- 저장된 데이터 중 해당 ID에 대한 칼럼을 1차원 배열로 가져와서 폼에 넣어 준다. -->
