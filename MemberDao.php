<?php
  class MemberDao {
    private $db;  //PDO 객체를 저장하기위한 property
    public function __construct() {  //php의 생성자는 __construct이다.
      try {
          $this->db = new PDO("mysql:host=localhost;dbname=php", "root", "");  //멤버변수에 접근하기 위해 this키워드 사용
