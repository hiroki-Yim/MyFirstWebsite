  ...
  <div id="login_btn" class="modal">
    ...
    <!-- Modal Content -->
    <form class="modal-content animate" action="../../Controller/login.php">
      <div class="imgcontainer">
        <img src="../../public/img/login_icon.svg" alt="Avatar" class="avatar">
      </div>    
      <div class="container wrapper">
        ...
        <button class="pwd cancelbtn" onclick="locationView('registerForm')">아직 회원이 아니세요?</button>
      </div>
    </form>
  </div>